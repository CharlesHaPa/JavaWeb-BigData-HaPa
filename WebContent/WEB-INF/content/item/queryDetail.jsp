...
<html>
	<head>
		...
		<link rel="stylesheet" href="<%= basePath %>item/css/zpp.css" />
		<script type="text/javascript" src="<%= basePath %>item/js/zpp.js" ></script>
						...
						<div class="order-select">
							<span style="margin-left: 100px;">
								<select id="selectItemType">
								    <option value="allTravel" ${itemType.equals("notTravel")?" selected=selected" : ""} }>全部订单</option>
							...
							<span style="margin-left: 100px;"><button type="submit" onclick="commit()" id="commit">查询</button></span>
								...
								<c:forEach items="${itemDetailList}" var="itemDetail" varStatus="status">
									...
									<tr>
										...
										<td>
											...
											<button type="button" onclick="endorse(${itemDetail.getOrderId()})"  class="btn${itemDetail.getStatus()}">改签</button>
										</td>
									</tr>
									<tr>
										<td colspan="7">
