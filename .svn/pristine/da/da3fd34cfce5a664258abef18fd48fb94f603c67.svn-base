...
<script type="text/javascript" src="<%=basePath %>main/js/cityData.js"></script>
<script type="text/javascript" src="<%=basePath %>main/js/cityPicker.js"></script>
...
$(function() {
		...
		<%if(session.getAttribute("query")=="true"){
	...
	<div class="container" style="display: inline; font-size: large;" id="nav">
		<ul class="nav nav-tabs row-fluid pull-right">
			...
			<div id="LoginBox">
				...
				<div class="row">
					<input type="button" name="" id="loginbtn" value="登录" onclick="login()" />
	...
	<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img src="<%=basePath%>assets/img/banner_img1.png" alt="1">
			</div>
			<div class="item">
				<img src="<%=basePath%>assets/img/banner_img2.png" alt="2">
			</div>
			<div class="item">
				<img src="<%=basePath%>assets/img/banner_img3.png" alt="3">
			</div>
		</div>
	</div>
